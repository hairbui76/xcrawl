...
2. ADR liên quan: `precode/adr/ADR-0002-run-state-model-split.md`, `precode/adr/ADR-0007-timezone-handling.md`.
...
| `SG-02` | Giá trị lịch, giới hạn đợt (200 post / 30 phút) đều PROVISIONAL. Không hard-code như thể đã chốt; đọc từ settings và ghi rõ nguồn PROVISIONAL trong log. |
