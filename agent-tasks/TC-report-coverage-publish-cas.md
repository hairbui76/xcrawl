...
2. `precode/adr/ADR-0011-frameworks-and-toolchain.md` — framework và toolchain mà §8 giả định (`provisional-accepted`; Owner có thể bác bất kỳ dòng nào mà không ảnh hưởng hợp đồng). Rồi các ADR nghiệp vụ: `precode/adr/ADR-0004-tag-freeze-point.md`, `precode/adr/ADR-0007-timezone-handling.md`, `precode/adr/ADR-0002-run-state-model-split.md`.
