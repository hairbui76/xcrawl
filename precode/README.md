...
**Pin hiện tại: `PC10-PIN-P5c-20260909`.** Trong 18 card, **8 card** nằm trọn trong phạm vi đã phê chuẩn
...
Epoch cũ, theo thứ tự bị thay: `PC10-PIN-P5b-20260908` ← `PC10-PIN-P4b-20260908` ← `PC10-PIN-P4-20260908` ← `PC10-PIN-P3b-20260908` ← `PC10-PIN-P3-20260908` ← `PC10-PIN-P2d-20260907` ← `PC10-PIN-P2c-20260907` ← `PC10-PIN-P2b-20260907` ← `PC10-PIN-P2-20260907` ← `PC10-PIN-P1d-20260907` ← `PC10-PIN-P1c-20260907` ← `PC10-PIN-P1b-20260907` ← `PC10-PIN-P1-20260907` ← `PC10-PIN-OD01e-20260907` ← `PC10-PIN-OD01d-20260907` ←
